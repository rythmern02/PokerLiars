...
const ParticipantCircle = ({ 
  ...
  const circleSize = totalPlayers <= 4 ? 80 : Math.max(50, 80 * (4 / totalPlayers));
    ...
    >
      ...
      >
        ...
        <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 
          bg-zinc-800 px-2 py-1 rounded text-xs text-white whitespace-nowrap
          ...
          <div className="flex-1">
            ...
            <div className="relative h-[500px] flex items-center justify-center">
              ...
              <div className="absolute w-32 h-32 rounded-full bg-zinc-900/80 border-2 border-[#98C23D] flex items-center justify-center z-10">
                <div className="text-center">
                  ...
                  <div className="text-2xl text-[#98C23D] font-bold">
            ...
            <div className="mt-8 max-w-md mx-auto">
              <div className="bg-zinc-900/80 border border-zinc-700 rounded-xl p-6 backdrop-blur-sm">
                ...
                <div className="mb-4">
                  <label className="block text-[#98C23D] text-sm mb-2">Betting Amount (ETH)</label>
                  <input
                    type="number"
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div>
                    <label className="block text-[#98C23D] text-sm mb-2">Digit to Bid</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="block text-[#98C23D] text-sm mb-2">Number of Occurrences</label>
                    <input
                      type="number"
          ...
          <div className="w-96 ml-8 flex flex-col gap-6">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <RiHashtag className="text-[#98C23D] text-xl" />
              ...
              <div className="relative">
                ...
                <div className="bg-zinc-900/50 rounded-lg p-4 border border-zinc-700 hover:border-[#98C23D] 
                  ...
                  <div className="grid grid-cols-10 gap-1">
                    {mySerialNumber.split('').map((digit, index) => (
                      <motion.div
                        key={index}
                ...
                {bidsHistory.map((bid, index) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-zinc-400 text-sm">{bid.player}</span>
                    </div>
              ...
              <div className="h-48 overflow-y-auto mb-4 space-y-2 custom-scrollbar">
                {chatHistory.map((msg, index) => (
                  <motion.div
                    ...
                    transition={{ delay: index * 0.1 }}
                    key={index}
                    className="text-sm p-2 rounded-lg hover:bg-zinc-800/50 transition-all duration-300"
                  >
